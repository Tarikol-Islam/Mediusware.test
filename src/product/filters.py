...
class ProductFilter(django_filters.FilterSet):
    ...
    variant = django_filters.ModelChoiceFilter(field_name='productvariant__variant_title',  queryset=ProductVariant.objects.all(),widget=forms.Select(attrs={'class': 'form-control'}) )
